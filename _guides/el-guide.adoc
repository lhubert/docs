...
= {project-name} Expression Language
...
Learn how to use Expression Language in {project-name} configurations
This guide covers:
...
We are currently using the **mvel** language which you can check http://mvel.documentnode.com/[mvel documentation]
