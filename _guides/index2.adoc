...
include::logisland-intro.adoc[tag=intro]
...
* email using the http://post-office.corp.redhat.com/mailman/listinfo/logisland-dev[logisland-dev@redhat.com] mailing list
* chat using https://logisland.zulipchat.com[Zulip]

Your help is more than welcome! Don't hesitate to join the crowd.

== Contributing

Check the https://github.com/logisland-project/logisland/blob/master/CONTRIBUTING.md[Contribution Guide] for details on reporting issues and the process for submitting pull requests.
...
This project is licensed under the Apache Software License 2.0 - see the https://github.com/logisland-project/logisland/blob/master/LICENSE.txt[License file] for details.
